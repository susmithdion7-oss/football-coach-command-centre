...
2. Inspect current source and CSS for only the target module.
3. Preserve existing interactions and data flows.
4. Use club theme variables such as `--club-primary`, `--club-secondary`, and `--club-accent`.
5. Improve spacing, hierarchy, density, responsive behavior, and selected/disabled states.
6. Check the module still feels like Coach Command Centre, not a generic webpage.
7. Test affected states and responsive widths.
